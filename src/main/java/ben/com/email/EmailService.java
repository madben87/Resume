...
public class EmailService {
    ...
    private final JavaMailSender mailSender; //see application-context.xml

    private final VelocityEngine velocityEngine; //see application-context.xml

    @Autowired
    public EmailService(VelocityEngine velocityEngine, JavaMailSender mailSender) {
