...
<div class="fixed-action-btn horizontal click-to-toggle">
    ...
    <ul>
        <li><a class="tooltipped btn-floating lighten-1" href="#localization" data-position="bottom" data-delay="50" data-tooltip="${language}"><i class="large material-icons">language</i></a></li>
        ...
        <li><a class="tooltipped btn-floating lighten-1" href="adminChat" data-position="bottom" data-delay="50" data-tooltip="${my_messages}"><i class="large material-icons">email</i></a></li>
        <li><button class="tooltipped btn-floating lighten-1" type="submit" form="logout_form" data-position="bottom" data-delay="50" data-tooltip="${log_out}"><i class="material-icons">input</i></button></li>
    </ul>
</div>

<c:url value="/logout" var="logout_c"/>
<form id="logout_form" action="${logout_c}" method="post"><security:csrfInput/></form>
